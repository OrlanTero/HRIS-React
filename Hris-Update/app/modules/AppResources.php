...
$TOTAL_BANK_HEADER_TEXT = ["No", "Bank", "Amount"];
$TOTAL_BANK_BODY_KEY = ["no", "bank", "amount"];

$ACCOUNT_CREDITED_HEADER_TEXT = ["No", "Employee", "Bank Account", "Amount"];
$ACCOUNT_CREDITED_BODY_KEY = ["no", "employee", "bank_account_number", "amount"];
...
$HOLIDAYS_TABLE_HEADER_TEXT = ["No", "Date", "Holiday", "Type"];
$HOLIDAYS_TABLE_BODY_KEY = ["no", "holiday_date", "holiday", "national_local"];
...
// ALL FINANCIAL
$PAYROLL_TABLE_HEADER_TEXT = ["No", "Name", "Days Worked", "Hours Worked", "Rest Day", "BASIC PAY", "NSD", "NSD(BP)", "NHW(SH)", "SH(BP)", "NHW(SHOT)", "SHOT(BP)", "NHW(LH)", "LH(BP)", "NHW(LHOT)", "LHOT(BP)", "Head Guard Allowance", "Rest Day", "Adjustments", "Gross Pay", "SSS", "PHIL", "INSURANCE", "P1", "Death", "Pag-Ibig", "P2", "P3", "Uniform", "Cash Advances", "Loan Statement", "Loan Purpose", "Beneficiaries", "Net Pay"];
$PAYROLL_TABLE_BODY_KEY = ["no", "name", "ndw", "total_hours", "rest_day", "basic_pay", "nsd", "nsd_basic_pay", "nhw_sh", "sh_basic_pay", "nhw_shot", "shot_basic_pay", "nhw_lh", "lh_basic_pay", "nhw_lhot", "lhot_basic_pay", ["property" => "payslip_rates", "target" => "head_guard_allowance"], "rest_day", "adjustments", "gross_pay", "sss", "phil", "insurance", "part1", "death", "pagibig", "part2", "others", ["property" => "payslip_rates", "target" => "uniform"], "cash_advances", "loan_statement", "loan_purpose", "beneficiaries", "netpay"];

$REQUISITION_TABLE_HEADER_TEXT = ["No", "Req#", "Date", "Remarks", "Status", "Expenses", "Less", "Amount", "Balance"];
$REQUISITION_TABLE_BODY_KEY = ["no", "req_id", "req_date", "remarks", "status", "total_expenses", "total_less", "amount", "balance"];
...
$REQUISITION_REPORT_TABLE_HEADER_TEXT = ["No", "Particulars", "Type", "Less", "Amount"];
$REQUISITION_REPORT_LESS_TABLE_BODY_KEY = ["no", "particulars", "type", "total_less", "amount"];

$DISBURSEMENT_TABLE_HEADER_TEXT = ["No", "Date", "Voucher #", "Payments", "Paid To", "Posted", "Cancelled", "Amount"];
$DISBURSEMENT_TABLE_BODY_KEY = [
    "no",
    "date",
    "voucher",
    "payments",
...
$CLIENT_HOLIDAY_TABLE_HEADER_TEXT = ["No", "Date", "Holiday", "Type"];
$CLIENT_HOLIDAY_TABLE_BODY_KEY = ["no", "date", "holiday", "type"];
...
$ARCHIVES_HEADER = ["NO", "CATEGORY", "TARGET", "USER", "DATE"];
$ARCHIVES_BODY = [
    "no",
    [
        "enum" => array_column(TableNames::cases(), 'name'),
        "value" => "category_id"
    ],
    "target_id",
    "user_id",
...
$NATIONAL_OR_LOCAL = array_column(NationalOrLocalTypes::cases(), 'value');
