...
enum NationalOrLocalTypes: string
{
    case NATIONAL = "National Holiday";

    case LOCAL = "Local Holiday";
}
...
enum AttendanceType: int
{
    ...
    case OT = 2;
    case NIGHT_DIFF = 3;
    case LEGAL_HOLIDAY = 4;
    case SPECIAL_HOLIDAY = 5;
    case REST_DAY = 6;
    case LEGAL_HOLIDAY_OT = 7;
    case SPECIAL_HOLIDAY_OT = 8;
}
...
enum TableNames: string
{
    ...
    case EMPLOYEE_ACCOUNT = "employee_account";
    case EMPLOYEES = "employees";
    case EMPLOYMENT = "employment";
    case MORTUARY = "mortuary";
    case BANKS = "banks";
    case EMPLOYEE_ASSIGNMENT = "employee_assignment";
    ...
    case ATTENDANCE_GROUP = "attendance_group";
    case BANK_ACCOUNT = "bank_account";
    case BENEFICIARY = "beneficiary";
    case CLIENT_HOLIDAY = "client_holiday";
    case EMPLOYEE_DEPLOYMENT = "deployed_employees";
    case PETTY_CASH = "petty_cash";

    case ARCHIVES = "archives";

    case DATABASE_BACKUPS = "database_backups";
...
enum SystemTypeAffectValue: int
{
    case NONE = 0;
