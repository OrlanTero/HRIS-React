...
//
    ...
    public function GetOverAllLoanBalanceOfEmployee($id)
    {
        ...
        try {
            ...
            $overallLoan = array_sum(array_column($control->filterRecords(['employee_id' => $id],false), 'balance'));

            // $overallPayment = array_sum(array_column($paymentControl->filterRecords(['employee_id' => $id], false), 'amount'));
