...
use Application\controllers\system\DatabaseBackupControl;
...
use Application\controllers\system\MortuaryPaymentControl;
use Application\controllers\system\PayslipControl;
use Application\controllers\system\PayslipDraftControl;
...
use Application\controllers\system\LoanAdvanceControl;
use Application\controllers\system\LoanStatementControl;
...
class GlobalFunctions
{
    ...
    public $DATABASE_BACKUPS_CONTROL;
    public $PAYSLIP_DRAFT_CONTROL;
    public $MORTUARY_PAYMENT_CONTROL;

    public $LOAN_ADVANCE_CONTROL;

    public $LOAN_STATEMENT_CONTROL;
    ...
    public function __construct($SESSION)
    {
        ...
        $this->DATABASE_BACKUPS_CONTROL = new DatabaseBackupControl();
        $this->PAYSLIP_DRAFT_CONTROL = new PayslipDraftControl();
        $this->MORTUARY_PAYMENT_CONTROL = new MortuaryPaymentControl();
        $this->LOAN_ADVANCE_CONTROL = new LoanAdvanceControl();
        $this->LOAN_STATEMENT_CONTROL = new LoanStatementControl();
        $this->ARCHIVE_CONTROL = new ArchiveControl();
    }
}