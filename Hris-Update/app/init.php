...
include_once "abstracts/PayslipAbstract.php";
include_once "abstracts/DatabaseBackupAbstract.php";
include_once "abstracts/PayslipDraftAbstract.php";
include_once "abstracts/MortuaryPaymentAbstract.php";
include_once "abstracts/LoanAdvanceAbstract.php";
include_once "abstracts/LoanStatementAbstract.php";
include_once "abstracts/ArchiveAbstract.php";
// ALL MODELS
...
include_once "models/DatabaseBackup.php";
include_once "models/PayslipDraft.php";
include_once "models/MortuaryPayment.php";
include_once "models/LoanAdvance.php";
include_once "models/LoanStatement.php";
...
include_once "controllers/system/DatabaseBackupControl.php";
include_once "controllers/system/PayslipDraftControl.php";
include_once "controllers/system/MortuaryPaymentControl.php";
include_once "controllers/system/LoanAdvanceControl.php";
include_once "controllers/system/LoanStatementControl.php";
include_once "controllers/system/ArchiveControl.php";
