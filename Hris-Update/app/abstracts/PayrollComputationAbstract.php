...
abstract class PayrollComputationAbstract extends ModelDefaultFunctions
{
    ...
    public $ndw; // no of days work

    public $nhw; // no of hours work

    public $basic_pay; // basic pay

    public $nsd; // night difference

    public $nsd_basic_pay; // night difference basic pay

    public $nhw_sh; // no of hours work special holiday

    public $nhw_lh; // no of hours work legal holiday

    public $lh_basic_pay; // legal holiday basic pay

    public $nhw_lhot; // no of hours work legal holiday overtime

    public $lhot_basic_pay; // legal holiday overtime basic pay

    public $sh_basic_pay; // special holiday basic pay

    public $nhw_shot; // no of hours work special holiday ot

    public $shot_basic_pay; // special holiday overtime basic pay

    public $gross_pay; // gross pay
    ...
    {
        return $this->cash_advances;
    }

    /**
     * @param mixed $cash_advances
     */
    public function setCashAdvances($cash_advances): void
    {
