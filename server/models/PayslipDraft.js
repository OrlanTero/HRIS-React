...
/**
 * PayslipDraft model
 * Represents the payslip_drafts table from database
 * @class PayslipDraft
 * @extends BaseModel
 */
class PayslipDraft extends BaseModel {
  /**
   * Create a new PayslipDraft instance
   * @param {Object} data - Initial data
   */
  constructor(data = {}) {
    super('payslip_drafts');
    this.payslip_draft_id = data.payslip_draft_id || null;
  ...
  /**
   * Find payslip draft by ID
   * @param {number} id - Payslip draft ID
   * @returns {Promise<PayslipDraft>}
   */
  async findById(id) {
    return super.findById('payslip_draft_id', id);
  }

  /**
   * Update payslip draft
   * @param {number} id - Payslip draft ID
   * @param {Object} data - Data to update
   * @returns {Promise<Object>}
   */
  async update(id, data) {
    return super.update('payslip_draft_id', id, data);
  }

  /**
   * Delete payslip draft
   * @param {number} id - Payslip draft ID
   * @returns {Promise<Object>}
   */
  async delete(id) {
    return super.delete('payslip_draft_id', id);
  }
}

module.exports = PayslipDraft; 